...
import TheoryDescription from '../TheoryDescription';
import TelescopeImage from '../../assets/images/telescope.jpg';
    ...
    <>
      <S.Wrapper>
        ...
        <S.ContentP>
          ...
          <p>
            ...
            infused space itself with a special energy that exerted a repulsive force, causing the 
            universe to swell faster than the speed of light for a prodigiously violent instant.
          </p>

          <p>
            If true, the rapid engorgement would solve paradoxes like why the heavens look uniform 
          ...
          <p>
            “SPECTACULAR REALIZATION,” Dr. Guth wrote across the top of the page and drew a double 
            box around it.
          </p>
          ...
          <p>
            ...
            at the South Pole, a team of astronomers led by John M. Kovac of the Harvard-Smithsonian Center 
        ...
        <S.Thanks>
          <h4>Thanks for reading The Times.</h4>
          <span>Subscribe to The Times</span>
        </S.Thanks>
        ...
        <S.ContentP>
          ...
          <p>
            If corroborated, Dr. Kovac’s work will stand as a landmark in science comparable to the 
        ...
        <S.ContentP>
          <p>
            In our own universe, it would serve as a window into the forces operating at energies 
            forever beyond the reach of particle accelerators on Earth and yield new insights into 
            gravity itself. Dr. Kovac’s ripples would be the first direct observation of gravitational 
          ...
          <p>
            ...
            that permeates space and preserves a picture of the universe when it was 380,000 years old and 
          ...
          <p>
            ...
            at the Center for Astrophysics here on Monday and in a set of papers submitted to The Astrophysical 
            Journal.
          </p>
        </S.ContentP>
      </ S.Wrapper>
      ...
      <S.Wrapper>
        <S.ContentP>
          ...
          <p>
            Dr. Guth, now 67, pronounced himself “bowled over,” saying he had not expected such a 
            definite confirmation in his lifetime.
          </p>
          ...
          <p>
            ...
            of his work to a select few, meeting with Dr. Guth, who is now a professor at Massachusetts 
            Institute of Technology (as is his son, Larry, who was sleeping that night in 1979), in his 
            office last week.
          </p>
        ...
        <S.Media>
          <iframe title="videoStanford" width="560" height="315" src="https://www.youtube.com/embed/ZlfIVEy_YOA" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
          <span><strong>Stanford Professor Andrei Linde celebrates physics breakthrough</strong> Video by StanfordUniversity</span>
        </S.Media>
        ...
        <S.ContentP>
          ...
          <p>
            ...
            project called the South Pole Telescope, pronounced himself deeply impressed. 
          ...
          <p>
            ...
            noting that the new results exceeded earlier estimates based on temperature maps of the cosmic 
        ...
        <S.ContentP>
          ...
          <p>
            ...
            leaders of Bicep, which has operated a series of increasingly sensitive radio telescopes at 
            the South Pole, where the thin, dry air creates ideal observing conditions. The others are 
        ...
        <S.Media>
          <img src={TelescopeImage} alt="telescope"></img>
          <span>
            <strong>The Bicep2 telescope, in the foreground, was used to detect the faint spiraling gravity patterns 
        ...
        <S.ContentP>
          ...
          <p>
            ...
            All of normal cosmic history was still ahead, resulting in today’s observable universe, a patch 
            of sky and stars billions of light-years across. “It’s often said that there is no such thing as
             a free lunch,” Dr. Guth likes to say, “but the universe might be the ultimate free lunch.”
          </p>
        ...
        <S.Footer>
          ...
          <S.IconInfo>
            <button>READ 615 COMMNETS</button>
            <FaFacebookF />
            <FaTwitter />
            <FaEnvelope />
            <IoMdShareAlt />
